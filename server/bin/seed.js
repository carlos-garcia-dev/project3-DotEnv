...
// const userCompany = {
//     name: 'Noelia de Lucas',
//     username: 'IT-IBM',
//     email: 'it-projects@ibm.com',
//     password: bcrypt.hashSync('password', salt),
//     userType: 'Company'
// }
...
//     .then(fillUserCompany => { 
//         for (let i = 0; i < 10; i++) {
//             userCompanyRole.push({
//                 name: faker.name.findName(),
//                 username: faker.internet.userName(),
//                 email: faker.internet.email(),
//                 password: bcrypt.hashSync('company', salt),
//                 userType: 'Company',
//                 avatar: faker.image.avatar(),
//             })
//             console.log(fillUserCompany)}})
//     .then(() => mongoose.connection.close())
//     .catch(err => console.log(err))
